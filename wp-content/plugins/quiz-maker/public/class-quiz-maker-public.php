...
class Quiz_Maker_Public {
    ...
    public function show_quiz($id, $attr){
        ...
        $quiz_integrations = array();
        $payment_terms = "lifetime";
        $paypal_client_id = null;
        $quiz_paypal =  false;
        $quiz_paypal_message = __('You need to pay to pass this quiz.', $this->plugin_name);
        $paypal_subscribtion_duration = '';
        $paypal_subscribtion_duration_by = 'day';
        ...
        $stripe_secret_key = '';
        $stripe_api_key = '';
        $stripe_payment_terms = 'lifetime';

        // Stripe parameters
        $enable_stripe = false;
        $stripe_amount = '';
        $stripe_currency = '';
        $stripe_message = __('You need to pay to pass this quiz.', $this->plugin_name);
